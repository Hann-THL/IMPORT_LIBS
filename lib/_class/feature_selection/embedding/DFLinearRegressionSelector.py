...
class DFLinearRegressionSelector(BaseEstimator, TransformerMixin):
    def __init__(self, columns=None, k=None, cv=RepeatedKFold(), **kwargs):
        self.columns        = columns
        self.k              = k
        self.cv             = cv
        self.selector       = SelectFromModel(LinearRegression(**kwargs))
    ...
    def fit(self, X, y):
        ...
        for train_index, test_index in splits:
            ...
            cv_scores.append(np.abs(self.selector.estimator_.coef_))
